...
namespace Week4
{
    class SoftwareDeveloper
    {
        ...
        private double MonthlyTax;// decleration of monthly tax amount
        ...
        private double getMonthlyTax() // returns monthly tax information Baised off of if the employee is W2 or 1099
        {
        ...
        private double getAnnualTax()// returns annual tax
        {
            return 12 * MonthlyTax;
        }
        private double getAnnualGrossPay()// returns annual gross pay
        {
